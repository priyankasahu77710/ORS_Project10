...
public abstract class BaseCtl<F extends BaseForm, T extends BaseDTO, S extends BaseServiceInt<T>> {
	...
	public ORSResponse get(@PathVariable long id) {
		System.out.println("BaseCtl Get() method run.......Priyanka sahu");
		ORSResponse res = new ORSResponse(true);
	...
	public ORSResponse delete(@PathVariable long id) {
		System.out.println("BaseCtl Delete() method run........Priyanka sahu");
		ORSResponse res = new ORSResponse(true);
		try {
	...
	public ORSResponse deleteMany(@PathVariable String[] ids, @RequestParam("pageNo") String pageNo,
			@RequestBody F form) {
		System.out.println("BaseCtl DeleteMany() method....Priyanka sahu... run");
		ORSResponse res = new ORSResponse(true);
		try {
...
//			}
			...
			System.out.println("Records Deleted Successfully by Priyanka sahu");
	...
	public ORSResponse save(@Valid @RequestBody F form, BindingResult bindingResult) {
		System.out.println("228save() run in BaseCtl :: +Priyanka sahu " + form);
	...
	public ORSResponse validate(BindingResult bindingResult) {
		ORSResponse res = new ORSResponse(true);
		System.out.println("inside the validate method of baseCtl. Priyanka sahu");
		if (bindingResult.hasErrors()) {
			...
			list.forEach(e -> {
				...
				System.out.println("Priyanka sahu.....validate");
